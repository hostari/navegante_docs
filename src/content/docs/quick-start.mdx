...
5.  ### Configure your App
    ...
    [App Configurations](reference/app-configurations-reference) are the individual repos that you added to your Infrastructure Project.
    ...
    To configure your App:
        ...
        2. All Navegante apps come with a free `*.navegante.app` subdomain. You can add your own custom domain name through the [Domains]() page.
...
6.  ### Deploy your App
    ...
    If you encounter no deployment errors,
...
<CardGrid>
  ...
  />
  <LinkCard
    title="Deploy Phoenix on Navegante"
    href="/framework-guides/fastapi"
    description="Everything you need to know about deploying your Phoenix app on Navegante."
  />
</CardGrid>
